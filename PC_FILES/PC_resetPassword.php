...
<head>
   ...
   <!--Made with love by Mutiullah Samim -->
	...
	<!--Custom styles-->
	<link rel="stylesheet" type="text/css" href="../css/styles-reset.css">
</head>
<body>
			...
			<div class="card-body">
				<form name="form" action="../lib/resetPasswordSend.php" method="POST">
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" placeholder="Introdueix el teu Correu" name="mail_reset">
					</div>
					<div class="form-group centerbutton">
						<input type="submit" value="Envia Correu" class="btn login_btn">
					</div>
				</form>
			</div>
		</div>
